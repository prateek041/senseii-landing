...
export default function Header() {
  return (
    ...
    >
      <div className="container mx-auto flex flex-col items-center justify-end px-4">
        {/* Text Content */}

        {/* Web View */}
        <div className="grid w-full grid-cols-6 grid-rows-6 gap-y-4">
          ...
          <div className="md:row-start-4 md:row-end-7 row-start-4 col-span-full flex justify-center ">
